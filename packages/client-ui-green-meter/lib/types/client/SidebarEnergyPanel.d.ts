...
export type SidebarEnergyPanelProps = PropsRuntime<'sidebar.energy'> & PropsLocale<'greenMeter'>;
/** The sidebar detail panel; closed/absent states render nothing. */
export declare function SidebarEnergyPanel({ useProjection, t }: SidebarEnergyPanelProps): import("react").JSX.Element | null;
export {};
