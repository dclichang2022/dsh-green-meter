 ...
 * budget rows; close dispatches the shared panel store action.
...
function panel(value: GreenMeterProjection | null | undefined, open: boolean): Mounted {
  if (getPanelState().open !== open) panelActions.toggle()
  const props = {
    t,
    useProjection: () => value,
